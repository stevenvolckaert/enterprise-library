namespace StevenVolckaert
{
    ...
    {
        /// <summary>
        ///     Returns the Unix time, also known as POSIX time or Epoch time, defined as the number of seconds
        ...
        /// <returns>
        ///     The Unix time, i.e. the number of seconds elapsed since 1970-01-01T00:00:00, not counting
        ///     leap seconds.
        /// </returns>
