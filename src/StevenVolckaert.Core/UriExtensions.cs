namespace StevenVolckaert
{
    ...
    public static class UriExtensions
    {
        ...
        /// <summary>
        /// Returns a new <see cref="Uri"/> which is one level of hierarchy above the current <see cref="Uri"/>,
        /// using the '/' character as delimiter.
        /// </summary>
        /// <param name="uri">The <see cref="Uri"/> this extension method affects.</param>
        /// <exception cref="ArgumentNullException"><paramref name="uri"/> is <c>null</c>.</exception>
        public static Uri UpOneLevel(this Uri uri)
        {
            ...
            return new Uri(uri.ToString().Remove(uri.ToString().LastIndexOf("/", StringComparison.OrdinalIgnoreCase)));
        }
    }
}
