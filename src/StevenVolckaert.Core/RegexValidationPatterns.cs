namespace StevenVolckaert
{
    ...
    {
        /// <summary>
        /// A regular expression pattern used to validate strings that represent a single ISO 3166-1 alpha-2 country
        /// code.
        /// </summary>
        public const string CountryCode = @"^[A-Z]{2}$";

        /// <summary>
        /// A regular expression pattern used to validate strings that represent a single culture name, as used by the
        /// <see cref="System.Globalization.CultureInfo"/> class.
        /// </summary>
        ...
        /// </summary>
        public const string EmailAddress = @"^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$";
