namespace StevenVolckaert
{
    ...
    public static class IEnumerableExtensions
    {
        ...
        /// <returns><c>true</c> if none of the elements in the <paramref name="source"/> sequence pass the test
        /// in the specified predicate; otherwise, <c>false</c>.</returns>
        ...
        /// <param name="source">An <see cref="IEnumerable{T}"/> instance whose elements do not
        /// contain <paramref name="element"/> when this operation returns.</param>
        /// <param name="element">An element that, if contained in <paramref name="source"/>,
        /// will be removed from the returned sequence.</param>
        /// <returns>A sequence that contains the set difference of <paramref name="source"/> and
        ...
        /// and <paramref name="other"/>.</typeparam>
        /// <param name="source">The sequence to check.</param>
        /// <param name="other">The sequence to compare with <paramref name="source"/>.</param>
        /// <returns><c>true</c> if <paramref name="source"/> is a subset of <paramref name="other"/>;
        /// otherwise, <c>false</c>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="other"/>
        ...
        /// <returns>An <see cref="IOrderedEnumerable{TSource}"/> whose elements are sorted according to
        /// the <see cref="object.ToString()"/> method of every element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <c>null</c>.</exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="keySelector"/> is
        /// <c>null</c>.</exception>
        ...
        /// <returns>An <see cref="IOrderedEnumerable{TSource}"/> instance whose elements are sorted according to
        /// the specified key.</returns>
        ...
        /// <returns>An <see cref="IEnumerable{T}"/> instance that doesn't contain the element at the end of
        ...
        /// <returns>An <see cref="IEnumerable{T}"/> instance that doesn't contain the specified number of elements at
        /// the end of the input sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <c>null</c>.</exception>
        ...
        /// </param>
        /// <returns>A <see cref="ReadOnlyObservableCollection{T}"/> instance that contains elements from the input
        /// sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <c>null</c>.</exception>
        ...
        /// <returns>A string that consists of the string representations of the elements
        /// contained in <paramref name="source"/>, separated with <paramref name="separator"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <c>null</c>.</exception>
        ...
        /// </summary>
        /// <typeparam name="TSource">The type of the elements in the input sequence.</typeparam>
        /// <param name="source">an <see cref="IEnumerable{T}"/> instance whose distinct elements
        /// form the first set for the union.</param>
        /// <param name="element">An element who forms the second set of the union.</param>
        /// <returns>An <see cref="IEnumerable{T}"/> that contains the elements of <paramref name="source"/>
